...
SCRIPT = [
    ...
    {"at": t(13, 58), "who": "narrator", "text": "The item is re-judged on the spot: sphere customers, which Work admits — but with no deadline it is only active, which is below Work’s bar, so it sits in Next rather than ringing. The name settles who she is; whether she may interrupt anyway is the separate question, one tick away in the same card."},
